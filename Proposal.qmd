...
By employing a data visualization package not covered in class, we aim to provide deeper insights and enhance our technical capabilities.

# Dataset Overview
The dataset, sourced from Kaggle, includes:
- **1000 Records**: Real data representing gaming trends.
- **Key Features**:
